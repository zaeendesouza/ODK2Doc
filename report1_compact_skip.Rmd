...
final <- final |>
  mutate(test_section = str_detect(Choices, "\\[", negate = 1)) |>
  mutate(Choices = ifelse(test = test_section == TRUE, 
                          yes = NA,
                          no = Choices)) |>
  mutate(Label = ifelse(test = test_section == TRUE, 
                          yes = "Section Name",
                          no = Label)) |>
...
final <- color(final, 
              ~ !is.na(Question) & Label!="Section Name", 
              1, 
              part  = "body", 
              color = "blue")

final <-  color(final, 
              ~ !is.na(Question) & Label!="Section Name", 3, 
                part = "body",
               color = "red")
final
